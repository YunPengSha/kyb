 ...
 */
public class SubjectMessageDo extends BaseDomain {
    private Integer id;
    ...
    public SubjectMessageDo(Integer subjectId, Integer userId,String subjectName, String message, SubjectMessageType subjectMessageType) {
