package net.sinyoo.cooperation.web.utils;
...
public class PublicUrl {
    ...
    static {
        ...
        publicUris.add("/uploadFile/registerUploadUserImage");//忘记密码，重置
        publicUris.add("/userRegister/tempRegister");//临时注册
        publicUris.add("/userRegister/addDoctorDetailInfo");//注册医生信息
        publicUris.add("/userRegister/addDepartmentDetailInfo");//注册科室信息
        publicUris.add("/userRegister/addDrugCompanyDetailInfo");//注册药企信息
        publicUris.add("/uploadFile/registerUploadUserImage");//注册时上传用户图片
        ...
        publicUris.add("/subjectList/list");//首页   科研列表
        publicUris.add("/subject/homeSubjectDetail");//首页   科研详情信息
        publicUris.add("/subjectPartIn/homeAgreeList");//首页  科研参与人列表
        publicUris.add("/userInfo/getDoctors/");//首页  获取搜索医生列表
        publicUris.add("/user/homeLinkDrugCompanyInfo");//首页  获取药企详细信息
        publicUris.add("/homeLink/drugCompany");//首页  获取药企列表
